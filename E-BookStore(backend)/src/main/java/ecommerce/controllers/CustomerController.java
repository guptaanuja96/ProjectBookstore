...
import ecommerce.services.IEmailSendingServices;
...
public class CustomerController {
	...
	@Autowired
    private IEmailSendingServices emailService;
...
//			return Response.success(cust);
	...
	public String newPassword(@RequestBody ForgotPasswordDTO emailDto) {
